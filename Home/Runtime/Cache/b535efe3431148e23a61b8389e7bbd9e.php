...
<body>
      <div class="box">
           <div class="top clearfix">
                 ...
                 <span>师大夜市</span>
                 <!--<div class="search">
                  <form action="<?php echo U('Shida/pro');?>" method="post">
                 <input type="text" placeholder="搜索美食" name="shangpinnane"/>
                 <div class="suosou"><input type="submit" value="提交"></div>
               </form>
                 </div>-->
           </div>
           <div class="con">
                       ...
                       <div class="text1">
                            ...
                            <p>已售
                            <?php  $bill=M('bill'); $where['shangpinid']=$p['shangpinid']; $where['shopid']=$p['shopid']; $where['_logic']="and"; $numarr= $bill->where($where)->select(); for($i=0;$i< count($numarr);$i++){ $a=$a+$numarr[$i]['num']; } echo $a; ?>
