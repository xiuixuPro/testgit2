...
<link rel="stylesheet" href="__PUBLIC__/editor/themes/default/default.css" />  
		...
		<script charset="UTF-8" src="__PUBLIC__/calendar.js"></script>  
            ...
            <script>  
                ...
                editor = K.create('textarea[name="shopaddress"]', {  
   ...
   resizeMode : 0,
						  ...
						  var editor2;  
                KindEditor.ready(function(K) {  
                editor2= K.create('textarea[name="shopinfo"]', {  
                                allowFileManager : true  ,
								  width : "70%", //编辑器的宽度为70%
    height : "300px", //编辑器的高度为100px
   resizeMode : 0,
...
<div class="row">
        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i>修改店铺</h2>
				
            </div>
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Shop/editact');?>" enctype="multipart/form-data" />

					 <div class="form-group">
                        <label for="exampleInput7">店铺名称</label><br>
                       <input type="hidden" name="shopid" value="<?php echo $a['shopid']?>">
					  <input required='required' type="text" class="form-control" id="exampleInput1" name="shopname" value="<?php echo $a['shopname']?>" ><span id="dsitename"></span>
                  
				   </div>
				   <div class="form-group">
                        <label for="exampleInput5">店铺照片</label><br>
                     
						  <input required='required'  type="text" value="<?php echo $a['shoppic']?>" name="shoppic" id="thumb"  size="50"/>  &nbsp;
							  <input type="button" id="image" value="上传图片" />  
						
				   </div>
                      <div class="form-group">
                        <label for="exampleInput5">店铺手机号</label><br>
                     
			
						
						   <input  required='required'  type="text" class="form-control" id="exampleInput2"  name="shoptel"   value="<?php echo $a['shoptel']?>"  ><span id="dsiteurl"></span><p style="color:gray;"></p>
                   
				   </div>
                    <script>
            var txt = document.getElementById('exampleInput2');
           // var btn = document.getElementById('dsiteurl');
            var reg = /13[0123569]{1}\d{8}|15[1235689]\d{8}|188\d{8}/;
...
* /")*/ 
            txt.onblur = function(){
                ...
                if( !reg.test(val)){
					...
					<div class="form-group">
                        <label for="exampleInput2">地址/摊位</label><br>
						
						<textarea name="shopaddress" id="content"    class="required"><?php echo $a['shopaddress']?> </textarea> 
                    </div>
					
					<div class="form-group">
                        <label for="exampleInput2">商户描述</label><br>
						
						<textarea name="shopinfo" id="describ"    class="required"><?php echo $a['shopinfo']?> </textarea> 
                    </div>
					
					
					<div class="form-group">
                        <label for="exampleInput2">是否出摊</label><br>
						是
					<input id="shopstatus"  type="radio"  name="shopstatus" value="1">
                否
						<input id="shopstatus"  type="radio"  name="shopstatus" value="0">
