 ...
 <div class="row">
        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i>添加视频讲座</h2>
				
            </div>
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Video/addact');?>" enctype="multipart/form-data" />
				   ...
				   <div class="form-group">
                        <label for="exampleInput5">视频封面</label><br>
						  ...
						  <input required='required'  type="text"  name="thumbfiles" id="thumb"  size="50"/>  &nbsp;
					...
					<div class="form-group">
                        <label for="exampleInput2">视频地址</label><br>
								...
								<textarea name="path" id="zizhi"   class="required"></textarea> 
					</div>
