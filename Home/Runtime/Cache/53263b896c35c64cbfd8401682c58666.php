...
<div class="row">
        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i>添加店铺</h2>
				
            </div>
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Shop/addact');?>" enctype="multipart/form-data" />

					 <div class="form-group">
                        <label for="exampleInput7">店铺名称</label><br>
                
					  <input required='required' type="text" class="form-control" id="exampleInput1" name="shopname"  ><span id="dsitename"></span>
                  
				   </div>
				   <div class="form-group">
                        <label for="exampleInput5">店铺照片</label><br>
                     
						  <input required='required'  type="text"  name="shoppic" id="thumb"  size="50"/>  &nbsp;
				    ...
				    <div class="form-group">
                        <label for="exampleInput5">店铺手机号</label><br>
						   ...
						   <input  required='required'  type="text" class="form-control" id="exampleInput2"  name="shoptel"  ><span id="dsiteurl"></span><p style="color:gray;"></p>
            ...
            txt.onblur = function(){
                ...
                if( !reg.test(val)){
					...
					<div class="form-group">
						...
						<textarea name="shopaddress" id="content"    class="required"> </textarea> 
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						是 
					<input type="radio" name="shopstatus"  value="1">
					否
					<input type="radio" name="shopstatus"  value="0">
                    </div>
