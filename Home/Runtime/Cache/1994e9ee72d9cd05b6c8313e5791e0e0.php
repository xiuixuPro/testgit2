...
<div class="ch-container">
 ...
 if ($groupid==1) { ?>
                        ...
                        <li><a class="ajax-link" href="<?php echo U('Member/index');?>"><i class="glyphicon glyphicon-list-alt"></i><span>&nbsp;会员中心</span></a>
                        </li>
                      ...
                      <li><a class="ajax-link" href="<?php echo U('Jifen/index');?>"><i class="glyphicon glyphicon-user"></i><span>积分明细</span></a>
                       ...
                       <li><a class="ajax-link" href="<?php echo U('Queryshop/index');?>">
						...
						<?php } elseif ($groupid==1 || $groupid==2) {?>
						 <li><a class="ajax-link" href="index.php/m/Member/a/index"><i class="glyphicon glyphicon-list-alt"></i><span>&nbsp;会员中心</span></a>
                        </li>
                        
						<li><a class="ajax-link" href="{:U('Video/index')}">
						<i
                                    class="glyphicon glyphicon-align-justify"></i><span>&nbsp;视频管理</span></a></li>
                       <li><a class="ajax-link" href="<?php echo U('Product/index');?>"><i
                                    class="glyphicon glyphicon-th"></i><span>产品相册管理</span></a></li>
...
<div class="row">
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Product/editact');?>" enctype="multipart/form-data" />

                   <div class="form-group">
                        <label for="exampleInput1">产品名称</label>
					
                 <input type="hidden" name="productid" value="<?php echo $a['productid']?>">
				   ...
				   <div class="form-group">
					...
					<div class="form-group">
                        <label for="exampleInput2">产品资质</label><br>
                      
								
								<textarea name="zizhi" id="zizhi"   class="required"> <?php echo $a['zizhi']?></textarea> 
					</div>
					<div class="form-group">
                        <label for="exampleInput2">产品内容</label><br>
