...
<div class="ch-container">
 ...
 <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>产品相册管理</h2>
				...
				-->
					...
					<form action="<?php echo U('Product/productquery');?>" method="post">
                        <label for="exampleInput7">查询：</label>
                        <input type="text"  name="name" placeholder="请输入产品名称">
						 <input type="submit" value="搜索">
                    </form>
					 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Product/add');?>">
						...
						<?php if(is_array($product_list)): $k = 0; $__LIST__ = $product_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k;?><tr class="del<?php echo $r['productid']; ?>"> 
							<td><?php echo ($k); ?></td>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo U('Product/edit',array('productid'=>$r['productid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    编辑
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['productid']; ?>)">
					   ...
					   <tr>
						<td colspan="7" align="center"><div class="page"><?php echo $productPage;?></div></td>
					   </tr>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php?m=Product&a=ajax",{"productid":id,"flag":"delajax"},function(e){
