            ...
            <div class="box-inner">
				...
				-->
                    <table class="table table-striped table-bordered responsive">
						...
						<form  name="myform" action="<?php echo U('Qishou/editact');?>" method="post">
                        <tr> 
                            <td><input type="text" value="<?php echo $a['name']?>" name="name"/></td>
							<input type="hidden" value="<?php echo $a['qishouid']?>" name="qishouid"/>
                            <td class="center">
							
							<input type="text" value="<?php echo $a['birth'];?>" name="birth" id="birthday"/>
							</td>
                            <td class="center"> 
							  <input type="text" name="thumbfiles" id="thumb" value="<?php echo $a['thumbfiles'];?>" size="50"/>  &nbsp;
							  <input type="button" id="image" value="上传图片" />  
							
							</td>
							<td class="center">
                              
							  <input type="text" value="<?php echo $a['duanwei']?>" name="duanwei"/>
							</td>
                            <td class="center">
                               
								
								<textarea name="rongyu" id="content"  style="width:800px;
height:250px;visibility:hidden;" class="required"> <?php echo $a['rongyu'] ?></textarea> 
