...
<head>
	...
	<style>
	.page{position:absolute;top:777px;left:340px;}
	...
	.page1{position:absolute;top:332px;left:340px;}
	.page1 a{border:1px solid #DDDDDD;display:inline-block;width:50px;height:40px;line-height:40px;text-align:center;border-radius:5px;}
	.page2{position:absolute;top:340px;left:200px;}
	.page2 a{border:1px solid #DDDDDD;display:inline-block;width:50px;height:40px;line-height:40px;text-align:center;border-radius:5px;}
...
<div class="ch-container">
    ...
    <thead>
	 ...
	 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Index/add');?>">
    ...
    <tbody>
	<?php if(is_array($saishi_list)): $i = 0; $__LIST__ = $saishi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['saishiid']; ?>">
        <td>
        ...
        <td class="center">
            ...
            <a class="btn btn-info" href="<?php echo U('Index/edit',array('saishiid'=>$r['saishiid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    Edit
                                </a>
            <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['saishiid']; ?>)">
                <i class="glyphicon glyphicon-trash icon-white"></i>
                Delete
            </a>
        </td>
    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    <div class="page"><?php echo $saishiPage;?></div>
	</tbody>
    </table>
    </div>
    </div>
