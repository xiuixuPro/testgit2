...
<?php }?>
 ...
 <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
				...
				-->
					...
					<form action="<?php echo U('Lookmember/lookquery');?>" method="post">
					   ...
					   <label for="exampleInput7">查询：</label>
						...
						<?php if(is_array($member_list)): $i = 0; $__LIST__ = $member_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['memberid']; ?>"> 
						  <td><?php echo $i?></td>
                            <td><?php echo $r['name']?></td>
                            <td class="center"><?php echo $r['jifen'];?></td>
                        
							
						
                            <td class="center">
                            
                                 <a class="btn btn-info" href="<?php echo U('Lookmember/lookjifen',array('memberid'=>$r['memberid']));?>">
						...
						<div align="center" ><?php echo $memberPage;?></div>
						</td>
						</tr>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php/m/Member/a/ajax",{"memberid":id,"flag":"delajax"},function(e){
