...
<div class="ch-container">
   ...
   <li><a class="ajax-link" href="index.php/m/Config/a/index"><i class="glyphicon glyphicon-cog"></i><span>&nbsp;网站设置</span></a>
						...
						<i
                                    class="glyphicon glyphicon-align-justify"></i><span>&nbsp;店铺管理</span></a></li>
									
									
                       <li><a class="ajax-link" href="<?php echo U('Shangpin/index');?>"><i
                                    class="glyphicon glyphicon-th"></i><span>商品管理</span></a></li>
        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>添加用户表</h2>
				...
				-->
				<form action="<?php echo U('User/addact');?>" method="post">
                        ...
                        <label for="exampleInput1">用户名称</label>
					
                 
                        <input required='required' type="text" class="form-control" id="exampleInput1" name="username" ><span id="dsitename"></span>
                    </div>
					 <div class="form-group">
                        <label for="exampleInput7">权限</label><br>
							<select name="groupid">
									<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><option value="<?php echo $r['roleid']?>"> <?php echo $r['rolename']?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
					
                 
				   </div>
				    <div class="form-group">
                        <label for="exampleInput1">用户密码</label>
					
                 
                        <input required='required' type="text" class="form-control" id="exampleInput1" maxlength="12" name="pwd" ><span id="dsitename"></span>
                    </div>
