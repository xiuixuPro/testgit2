...
<div class="ch-container">
 ...
 <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>商户管理</h2>
				...
				-->
					...
					<form action="<?php echo U('Shop/shopquery');?>" method="post">
                        ...
                        <input type="text"  name="shopname" placeholder="请输入商户名称">
						 <input type="submit" value="搜索">
                    </form>
					 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Shop/add');?>">
						...
						<?php if(is_array($shop_list)): $i = 0; $__LIST__ = $shop_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['shopid']; ?>">
                            ...
                            <td class="center"><?php echo ($r['shoptel']); ?></td>	
							  <td class="center"><?php echo ($r['shopinfo']); ?></td>	
							<td class="center"><input type="checkbox" disabled="disabled" <?php if ($r['shopstatus']==0) {echo "";}else{echo "checked";}?>></td>	
							   <td class="center">
							   
							     <a class="btn btn-warning" href="<?php echo U('Shangpin/index',array('shopid'=>$r['shopid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-yellow"></i>
                                    商品管理
                                </a>
						   ...
						   <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo U('Shop/edit',array('shopid'=>$r['shopid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    编辑
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['shopid']; ?>)">
					   ...
					   <tr>
						<td colspan="9">
						 <div class="page" align="center"><?php echo $shopPage;?></div>
						</td>
					   </tr>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php?m=Shop&a=ajax",{"shopid":id,"flag":"delajax"},function(e){
