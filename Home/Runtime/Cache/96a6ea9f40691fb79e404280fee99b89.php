...
<div class="ch-container">
 ...
 <div class="row">
            ...
            <div class="box-inner">
				...
				-->
					...
					<form action="<?php echo U('Qishou/qishouquery');?>" method="post">
						...
						<?php if(is_array($qishou_list)): $i = 0; $__LIST__ = $qishou_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['qishouid']; ?>"> 
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo U('Qishou/edit',array('qishouid'=>$r['qishouid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    Edit
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['qishouid']; ?>)">
					    ...
					    <div class="page"><?php echo $qishouPage;?></div>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php?m=Qishou&a=ajax",{"qishouid":id,"flag":"delajax"},function(e){
