        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>商品查询</h2>
				...
				-->
                    <table class="table table-striped table-bordered responsive">
						...
						<?php if(is_array($shangpin_lists)): $i = 0; $__LIST__ = $shangpin_lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr>
							<td class="center"><?php echo ($i); ?></td>						
                            <td class="center"><?php echo ($r['shangpinname']); ?></td>
							  <td class="center"><?php echo ($r['shangpintype']); ?></td>
							<td class="center"> 
