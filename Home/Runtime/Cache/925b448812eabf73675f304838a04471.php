            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="<?php echo U('Index/table');?>"><i class="glyphicon glyphicon-home"></i><span> Dashboard</span></a>
                        </li>
        ...
        <div class="box-inner homepage-box">
            ...
            <div class="box-content">
                ...
                <a class="btn btn-default center-block col-md-6" title="GitHub"
                   href="#" target="_blank"><i class="icon-edit"></i> View on
                    GitHub</a>
                ...
                <p>You may like my other open source work, check my profile on <a href="#"
