...
<div class="ch-container">
 ...
 <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
				...
				-->
					...
					<form action="<?php echo U('Video/videoquery');?>" method="post">
                        <label for="exampleInput7">查询：</label>
                        <input type="text"  name="title" placeholder="请输入讲座名称">
						 <input type="submit" value="搜索">
                    </form>
					 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Video/add');?>">
						...
						<?php if(is_array($video_list)): $i = 0; $__LIST__ = $video_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['videoid']; ?>">
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo U('Video/edit',array('videoid'=>$r['videoid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    编辑
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['videoid']; ?>)">
					   ...
					   <tr>
						<td colspan="4">
						 <div class="page" align="center"><?php echo $videoPage;?></div>
						</td>
					   </tr>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php?m=Video&a=ajax",{"videoid":id,"flag":"delajax"},function(e){
