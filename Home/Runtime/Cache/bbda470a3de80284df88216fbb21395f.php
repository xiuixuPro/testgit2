 ...
 <div class="row">
        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i>添加商品</h2>
				
            </div>
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Shangpin/addact');?>" enctype="multipart/form-data" />
<input type="hidden" value="<?php echo $a['shangpinid']?>" name="shangpinid">
                         
					 <div class="form-group">
                        <label for="exampleInput7"> 商品名称</label><br>
                      
					  <input required='required' type="text" class="form-control" id="exampleInput1" name="shangpinname" >
                  
                 
                 
				   </div>
				   	 <div class="form-group">
                        <label for="exampleInput7"> 商品类别</label><br>
                      
					
                  <select name="shangpintype">
				  <option value="主食"> 主食</option>
					<option value="面食"> 面食</option>
				      ...
				      <div class="form-group">
                        <label for="exampleInput5">所属商户</label><br>
                     <input type="hidden" name="shopid" value="<?php echo $shangpin['shopid']?>">
						 <select name="shopid" disabled="disabled">
									
										<option
										

										value="<?php echo $shangpin['shopid']?>"> <?php echo $shangpin['shopname']?> </option>
				   ...
				   <div class="form-group">
                        <label for="exampleInput5">商品图片</label><br>
						  ...
						  <input required='required'  type="text"  name="shangpinpic" id="thumb"  size="50"/>  &nbsp;
				   ...
				   <div class="form-group">
                        <label for="exampleInput5">商品价格</label><br>
						  ...
						  <input required='required'  type="number"   name="shangpinmoney" size="50" />  &nbsp;
					...
					<div class="form-group">
                        <label for="exampleInput2">商品简介</label><br>
								...
								<textarea name="shangpininfo" id="shangpininfo"   class="required"></textarea> 
					</div>
					<div class="form-group">
