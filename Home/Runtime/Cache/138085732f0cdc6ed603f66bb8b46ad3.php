        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>添加产品</h2>
				...
				-->
					...
					<form action="<?php echo U('Product/productquery');?>" method="post">
                        ...
                        <input type="text"  name="qname" placeholder="请输入产品名称">
					 ...
					 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Product/add');?>">
						...
						<?php if(is_array($a)): $k = 0; $__LIST__ = $a;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k;?><tr class="del<?php echo $r['productid']; ?>"> 
							<td><?php echo ($k); ?></td>
