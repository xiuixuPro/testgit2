 ...
 <div class="row">
        ...
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i>修改视频讲座</h2>
				
            </div>
            <div class="box-content">
                <form name="myform" method="post" action="<?php echo U('Video/editact');?>" enctype="multipart/form-data" />
<input type="hidden" value="<?php echo $a['videoid']?>" name="videoid">
                   
					 <div class="form-group">
                        <label for="exampleInput7">产品标题</label><br>
                      
					  <input required='required' type="text" value="<?php echo $a['title'];?>" class="form-control" id="exampleInput1" name="title" ><span id="dsitename"></span>
                  
                 
                 
				   </div>
				   <div class="form-group">
                        <label for="exampleInput5">视频封面</label><br>
                     
						  <input required='required'  type="text" value="<?php echo $a['thumbfiles'];?> " name="thumbfiles" id="thumb"  size="50"/>  &nbsp;
							  <input type="button" id="image" value="上传图片" />  
						
				   </div>
                   
					<div class="form-group">
                        <label for="exampleInput2">视频地址</label><br>
                      
								
								<textarea name="path" id="zizhi"   class="required"><?php echo $a['path'];?></textarea> 
					</div>
