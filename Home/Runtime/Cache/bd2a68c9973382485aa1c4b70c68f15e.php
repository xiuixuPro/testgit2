        ...
        <div class="box col-md-12">
            <div class="box-inner">
				...
				-->
						...
						<form action="<?php echo U('Index/editact');?>" method="post">
                    <table class="table table-striped table-bordered responsive" >
                        ...
                        <tr> 
                            <td><input type="text" name="saishititle" value="<?php echo $saishi_show['saishititle']?>" placeholder="请填入赛事标题"/></td>
							<input type="hidden" name="saishiid" value="<?php echo $saishi_show['saishiid']?>"/>
                            <td class="center">
								<select name="saishicateid">
									<?php if(is_array($saishicate_list)): $i = 0; $__LIST__ = $saishicate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><option 
										<?php if($saishi_show['saishicateid']==$r["saishicateid"]) echo "selected";?>	
										
										
										value="<?php echo $r['saishicateid']?>"> <?php echo $r['saishicatename']?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</td>
							<td><input type="text" name="timeline" placeholder="请填入赛事时间" id="birthday" value="<?php echo $saishi_show['timeline'] ?>"/></td>
							<td><input type="checkbox" name="new" 
							
							
							
							value="<?php echo $saishi_show['new'] ?>"/>最新</td>
                            <td><input type="checkbox" name="hot" value="<?php echo $saishi_show['hot'] ?>"/>最热</td>
                           <td class="center">
								<select name="saishiareaid">
									<?php if(is_array($saishiarea_list)): $i = 0; $__LIST__ = $saishiarea_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><option 
										<?php if($saishi_show['saishiareaid']==$r["saishiareaid"]) echo "selected";?>	
										
										
										value="<?php echo $r['saishiareaid']?>"> <?php echo $r['saishiareaname']?> </option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</td>
