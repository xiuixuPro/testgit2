...
<head>
	...
	<style>
	.page{position:absolute;top:12px;left:400px;}
 ...
 <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content" style="height:1599px;position:relative;">
				<!--
				...
				-->
                    <table class="table table-striped table-bordered responsive">
                        <thead>
							 ...
							 <a style="margin-left:950px;margin-bottom:15px;" class="btn btn-success" href="<?php echo U('Qishou/add');?>">
						...
						<?php if(is_array($zhishi_list)): $i = 0; $__LIST__ = $zhishi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['zhishiid']; ?>"> 
                            <td><?php echo ($r['zhishiname']); ?></td>
                            <td class="center">
							<img src="/vgo/<?php echo $r['zhishipic'];?>">
							
							</td>
                            <td class="center"> 
							<?php echo $r['zhishicontent']?>
							
							</td>
								<td class="center">
                              <?php echo ($r['zhishicatename']); ?>
							</td>
                           
						
                            <td class="center">
                            
                                <a class="btn btn-info" href="<?php echo U('Shiti/edit',array('zhishiid'=>$r['zhishiid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    Edit
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['zhishiid']; ?>)">
					    ...
					    <div class="page"><?php echo $zhishiPage;?></div>
		...
		function ajax(id)
	{
		...
		{
			$.post("index.php?m=Shiti&a=ajax",{"shitiid":id,"flag":"delajax"},function(e){
