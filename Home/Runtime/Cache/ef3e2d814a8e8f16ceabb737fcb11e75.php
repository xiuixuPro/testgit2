        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-user"></i>前台用户管理</h2>
					   ...
					   <label for="exampleInput7">查询：</label>
						...
						<?php if(is_array($member_list)): $i = 0; $__LIST__ = $member_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr class="del<?php echo $r['memberid']; ?>"> 
						  <td><?php echo $i?></td>
                            ...
                            <td class="center"> 
							<?php echo $r['membertel']?>
							
							</td>
								<td class="center">
                             
							  <img src="<?php echo $r['memberpic']?>">
							</td>
                           
						
                            <td class="center">
                            
                                <a class="btn btn-info" href="<?php echo U('Member/edit',array('memberid'=>$r['memberid']));?>">
                                    <i class="glyphicon glyphicon-edit icon-white"></i>
                                    编辑
                                </a>
                                <a class="btn btn-danger" href="javascript:;" onclick="ajax(<?php echo $r['memberid']; ?>)">
